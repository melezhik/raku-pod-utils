...
subtest {
    eval-dies-ok('use Pod::Utilities; first-code-block();', "pod argument required");
    eval-dies-ok('use Pod::Utilities; first-code-block("moo");', "array argument required");
...
subtest {
    plan 7;
    eval-dies-ok('use Pod::Utilities; pod-with-title();', "title argument required");
...
subtest {
    ...
    isa-ok($pod, Pod::Block::Named);
    eval-dies-ok('use Pod::Utilities; pod-title()', "title argument required");
...
subtest {
    plan 6;
    eval-dies-ok('use Pod::Utilities; pod-link()', "text argument required");
    eval-dies-ok('use Pod::Utilities; pod-link("text")', "link argument required");
...
subtest {
    plan 4;
    eval-dies-ok('use Pod::Utilities; pod-bold()', "text argument required");
...
subtest {
    plan 6;
    eval-dies-ok('use Pod::Utilities; pod-heading()', "name argument required");
...
subtest {
    plan 4;
    eval-dies-ok('use Pod::Utilities; pod-table();', "contents argument required");
    eval-dies-ok('use Pod::Utilities; pod-table("");', "fails with empty string argument");
